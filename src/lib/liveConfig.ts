...
export const fishList = [
  ...
  { name: "🪸红珊瑚", hookRate: 0.40, value: 1 },
  { name: "🪱泥虫", hookRate: 0.40, value: 1 },
  { name: "🦐沙虾", hookRate: 0.40, value: 1 },
  { name: "🪼红骨水母", hookRate: 0.40, value: 1 },
  { name: "🌊滩海蜇", hookRate: 0.40, value: 1 },
  { name: "🐟沙丘鱼", hookRate: 0.40, value: 1 },
  { name: "🐠浪花鱼", hookRate: 0.40, value: 1 },
  { name: "🐚红蛏子", hookRate: 0.40, value: 1 },
  { name: "🐌军舰海螺", hookRate: 0.40, value: 1 },
  { name: "⚔️战斧海马", hookRate: 0.40, value: 1 },
  { name: "🐍海蛇", hookRate: 0.40, value: 1 },
  { name: "🐡鸟嘴鱼", hookRate: 0.40, value: 1 },
  { name: "🎣小嘴海鲈", hookRate: 0.40, value: 1 },
  { name: "🐟红衫鱼", hookRate: 0.40, value: 1 },
  { name: "🦐眼镜虾", hookRate: 0.40, value: 1 },
  { name: "🫠咸鱼", hookRate: 0.40, value: 1 },
  { name: "🌀钻头贝", hookRate: 0.40, value: 1 },
  { name: "👑鲤鱼王", hookRate: 0.40, value: 1 },

  { name: "🐚回音海螺", hookRate: 0.35, value: 2 },
  { name: "🦀三钳蟹", hookRate: 0.35, value: 2 },
  { name: "🦐樱花虾", hookRate: 0.35, value: 2 },
  { name: "🌿蓝海草", hookRate: 0.35, value: 2 },
  { name: "🐟沙丁鱼", hookRate: 0.35, value: 2 },
  ...
  { name: "🍲红烧鱼(生)", hookRate: 0.35, value: 2 },
  { name: "🥢清蒸鱼(生)", hookRate: 0.35, value: 2 },
  { name: "🌶麻辣鱼(生)", hookRate: 0.35, value: 2 },
  { name: "🌟星鱼", hookRate: 0.35, value: 2 },
  { name: "🌀漩涡鱼", hookRate: 0.35, value: 2 },
  { name: "🪼浅滩水母", hookRate: 0.35, value: 2 },
  { name: "💥爆炸河豚", hookRate: 0.35, value: 2 },
  { name: "🍣鲑鱼", hookRate: 0.35, value: 2 },
  { name: "🦀潮汐蟹", hookRate: 0.35, value: 2 },
  { name: "🎈泡泡鱼", hookRate: 0.35, value: 2 },
  { name: "🐟咸水鲤鱼", hookRate: 0.35, value: 2 },
  { name: "🥘西湖醋鱼", hookRate: 0.35, value: 2 },
  { name: "👻隐身鱼", hookRate: 0.35, value: 2 },
  { name: "⭐杨桃鱼", hookRate: 0.35, value: 2 },
  ...
  { name: "🫐蓝莓水母", hookRate: 0.30, value: 3 },
  { name: "💎玛瑙珊瑚", hookRate: 0.30, value: 3 },
  { name: "🐧企鹅鲨鱼", hookRate: 0.30, value: 3 },
  { name: "✨荧光鱼", hookRate: 0.30, value: 3 },
  { name: "🍎苹果蟹", hookRate: 0.30, value: 3 },
  { name: "🕷️海蜘蛛", hookRate: 0.30, value: 3 },
  { name: "💍珍珠贝", hookRate: 0.30, value: 3 },
  { name: "🦪枸杞生蚝", hookRate: 0.30, value: 3 },

  { name: "🔱朗基努斯鱼", hookRate: 0.27, value: 4 },
  { name: "🧚仙女海马", hookRate: 0.27, value: 4 },
  { name: "🐾肉球海豹", hookRate: 0.27, value: 4 },
  { name: "🛡️Chieftain Mk.VI", hookRate: 0.27, value: 4 },
  { name: "🐋烏爾比安", hookRate: 0.27, value: 4 },
  { name: "🦈幽靈鯊", hookRate: 0.27, value: 4 },
...
export const backupConfig: BackupMapping[] = [
  ...
  //匹配区
  {
    from: { chat_id: -2742074355, threadId: 302677 },
    to: [
      { chat_id: -3066803437, threadId: 4 }
    ]
  },
  //紫罗兰之花
  {
    from: { chat_id: -2742074355, threadId: 1161 },
    to: [
      { chat_id: -3066803437, threadId: 6 }
    ]
  },
  //酒馆
  {
    from: { chat_id: -2742074355, threadId: 48 },
    to: [
      { chat_id: -3066803437, threadId: 8 }
    ]
  },
  //教堂
  {
    from: { chat_id: -2742074355, threadId: 62 },
    to: [
      { chat_id: -3066803437, threadId: 10 }
    ]
  },
  //艺术馆
  {
    from: { chat_id: -2742074355, threadId: 284999 },
    to: [
      { chat_id: -3066803437, threadId: 12 }
    ]
  },
  //伊莲娜
  {
    from: { chat_id: -2742074355, threadId: 194 },
    to: [
      { chat_id: -3066803437, threadId: 93 }
    ]
  },
  //摄影棚
  {
    from: { chat_id: -2742074355, threadId: 232551 },
    to: [
      { chat_id: -3066803437, threadId: 91 }
    ]
  },
  //紫罗兰学院https://t.me/c/2742074355//636402
  {
    from: { chat_id: -2742074355, threadId: 514627 },
    to: [
      { chat_id: -3066803437, threadId: 89 }
    ]
  },
  //玉宝
  {
    from: { chat_id: -2742074355, threadId: 251 },
    to: [
      { chat_id: -3066803437, threadId: 87 }
    ]
  },
  //客房1
  {
    from: { chat_id: -2742074355, threadId: 467843 },
    to: [
      { chat_id: -3066803437, threadId: 85 }
    ]
  },
  //女皇
  {
    from: { chat_id: -2742074355, threadId: 215 },
    to: [
      { chat_id: -3066803437, threadId: 83 }
    ]
  },
  //客房2
  {
    from: { chat_id: -2742074355, threadId: 74050 },
    to: [
      { chat_id: -3066803437, threadId: 81 }
    ]
  },
  //行商小屋
  {
    from: { chat_id: -2742074355, threadId: 338 },
    to: [
      { chat_id: -3066803437, threadId: 79 }
    ]
  },
  //FuFu
  {
    from: { chat_id: -2742074355, threadId: 448929 },
    to: [
      { chat_id: -3066803437, threadId: 77 }
    ]
  },
  //审判庭https://t.me/c/2742074355//513532
  {
    from: { chat_id: -2742074355, threadId: 389 },
    to: [
      { chat_id: -3066803437, threadId: 75 }
    ]
  },
  //跑团
  {
    from: { chat_id: -2742074355, threadId: 55106 },
    to: [
      { chat_id: -3066803437, threadId: 73 }
    ]
  },
  //委托墙https://t.me/c/2742074355//621182
  {
    from: { chat_id: -2742074355, threadId: 584924 },
    to: [
      { chat_id: -3066803437, threadId: 71 }
    ]
  },
  //图书馆
  {
    from: { chat_id: -2742074355, threadId: 205 },
    to: [
      { chat_id: -3066803437, threadId: 69 }
    ]
  },
  //闪闪
  {
    from: { chat_id: -2742074355, threadId: 244 },
    to: [
      { chat_id: -3066803437, threadId: 67 }
    ]
  },
  //广场
  {
    from: { chat_id: -2742074355, threadId: 246576 },
    to: [
      { chat_id: -3066803437, threadId: 65 }
    ]
  },
  //大会堂
  {
    from: { chat_id: -2742074355, threadId: 301724 },
    to: [
      { chat_id: -3066803437, threadId: 63 }
    ]
  },
  //爬塔
  {
    from: { chat_id: -2742074355, threadId: 497929 },
    to: [
      { chat_id: -3066803437, threadId: 61 }
    ]
  },
  //耀阳
  {
    from: { chat_id: -2742074355, threadId: 382 },
    to: [
      { chat_id: -3066803437, threadId: 59 }
    ]
  },
  //kago
  {
    from: { chat_id: -2742074355, threadId: 141941 },
    to: [
      { chat_id: -3066803437, threadId: 57 }
    ]
  },
  //酥酥
  {
    from: { chat_id: -2742074355, threadId: 165 },
    to: [
      { chat_id: -3066803437, threadId: 55 }
    ]
  },
  //人设
  {
    from: { chat_id: -2742074355, threadId: 21237 },
    to: [
      { chat_id: -3066803437, threadId: 53 }
    ]
  },
  //软软
  {
    from: { chat_id: -2742074355, threadId: 182 },
    to: [
      { chat_id: -3066803437, threadId: 51 }
    ]
  },
  //琉璃
  {
    from: { chat_id: -2742074355, threadId: 33861 },
    to: [
      { chat_id: -3066803437, threadId: 49 }
    ]
  },
  //汐汐
  {
    from: { chat_id: -2742074355, threadId: 258 },
    to: [
      { chat_id: -3066803437, threadId: 47 }
    ]
  },
  //设定
  {
    from: { chat_id: -2742074355, threadId: 334 },
    to: [
      { chat_id: -3066803437, threadId: 45 }
    ]
  },

  //万事屋
  {
    from: { chat_id: -2742074355, threadId: 444725 },
    to: [
      { chat_id: -3066803437, threadId: 43 }
    ]
  },

  //牡丹群岛
  {
    from: { chat_id: -2742074355, threadId: 454656 },
    to: [
      { chat_id: -3066803437, threadId: 41 }
    ]
  },

  //满月
  {
    from: { chat_id: -2742074355, threadId: 361 },
    to: [
      { chat_id: -3066803437, threadId: 39 }
    ]
  },

  //缘宝
  {
    from: { chat_id: -2742074355, threadId: 88693 },
    to: [
      { chat_id: -3066803437, threadId: 37 }
    ]
  },

  //YOLO
  {
    from: { chat_id: -2742074355, threadId: 621178 },
    to: [
      { chat_id: -3066803437, threadId: 35 }
    ]
  },

  //后花园
  {
    from: { chat_id: -2742074355, threadId: 202 },
    to: [
      { chat_id: -3066803437, threadId: 33 }
    ]
  },

  //桌游
  {
    from: { chat_id: -2742074355, threadId: 345 },
    to: [
      { chat_id: -3066803437, threadId: 31 }
    ]
  },
  //落雪
  {
    from: { chat_id: -2742074355, threadId: 234072 },
    to: [
      { chat_id: -3066803437, threadId: 29 }
    ]
  },
  //小小M
  {
    from: { chat_id: -2742074355, threadId: 211 },
    to: [
      { chat_id: -3066803437, threadId: 26 }
    ]
  },
  //娜链
  {
    from: { chat_id: -2742074355, threadId: 503851 },
    to: [
      { chat_id: -3066803437, threadId: 24 }
    ]
  },
  //电竞
  {
    from: { chat_id: -2742074355, threadId: 80 },
    to: [
      { chat_id: -3066803437, threadId: 22 }
    ]
  },
  //魔法少女
  {
    from: { chat_id: -2742074355, threadId: 176 },
    to: [
      { chat_id: -3066803437, threadId: 20 }
    ]
  },
  //兰兰
  {
    from: { chat_id: -2742074355, threadId: 168 },
    to: [
      { chat_id: -3066803437, threadId: 18 }
    ]
  },
  //小母龙
  {
    from: { chat_id: -2742074355, threadId: 7571 },
    to: [
      { chat_id: -3066803437, threadId: 16 }
    ]
  },
  //音
  {
    from: { chat_id: -2742074355, threadId: 184 },
    to: [
      { chat_id: -3066803437, threadId: 14 }
    ]
  },
